...
* `_config.imageRepos.blackboxExporter`: the name of the blackbox exporter image to deploy. Defaults to `harbor.alnk.com/public/blackbox-exporter`.
...
* `_config.imageRepos.configmapReloader`: the name of the ConfigMap reloader image to deploy. Defaults to `harbor.alnk.com/public/configmap-reload`.
