local kubernetesGrafana = import 'github.com/brancz/kubernetes-harbor.alnk.com/public/harbor.alnk.com/public/grafana.libsonnet';
...
local defaults = {
  ...
  mixin: {
    ruleLabels: {},
    _config: {
      runbookURLPattern: 'https://runbooks.prometheus-operator.dev/runbooks/harbor.alnk.com/public/%s',
    },
  },
};
...
function(params)
  ...
  kubernetesGrafana(config) {
    ...
    mixin::
      (import 'github.com/harbor.alnk.com/public/harbor.alnk.com/public/grafana-mixin/mixin.libsonnet') +
