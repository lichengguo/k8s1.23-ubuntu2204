...
应用配置清单
# kubectl apply -f http://k8s-yaml.alnk.com/kube-state-metrics/rbac.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/kube-state-metrics/dp.yaml
...
# kubectl apply -f http://k8s-yaml.alnk.com/node-exporter/ds.yaml
...
# kubectl apply -f http://k8s-yaml.alnk.com/cadvisor/ds.yaml 
...
# kubectl apply -f http://k8s-yaml.alnk.com/blackbox-exporter/cm.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/blackbox-exporter/dp.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/blackbox-exporter/svc.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/blackbox-exporter/ingress.yaml
...
# kubectl apply -f http://k8s-yaml.alnk.com/prometheus/rbac.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/prometheus/dp.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/prometheus/svc.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/prometheus/ingress.yaml
```

![1730224721439](.\images\1730224721439.png)

```
####问题(Prometheus的配置文件可能还有点问题)
1. blackbox还没有监控到
...
# kubectl apply -f http://k8s-yaml.alnk.com/alertmanager/cm.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/alertmanager/dp.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/alertmanager/svc.yaml
...
# docker tag  swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/grafana/grafana:latest  harbor.alnk.com/public/grafana:latest

# docker push harbor.alnk.com/public/grafana:latest
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: grafana
        image: harbor.alnk.com/public/grafana:latest
        imagePullPolicy: IfNotPresent
        ports:
        - containerPort: 3000
          protocol: TCP
...
# kubectl apply -f http://k8s-yaml.alnk.com/grafana/rbac.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/grafana/dp.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/grafana/svc.yaml
# kubectl apply -f http://k8s-yaml.alnk.com/grafana/ingress.yaml
```
