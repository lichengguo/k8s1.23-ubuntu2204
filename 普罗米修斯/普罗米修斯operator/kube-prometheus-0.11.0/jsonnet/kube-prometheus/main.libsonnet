...

{
  ...
  values:: {
    common: {
      ...
      images: {
        alertmanager: 'harbor.alnk.com/public/alertmanager:v' + $.values.common.versions.alertmanager,
        blackboxExporter: 'harbor.alnk.com/public/blackbox-exporter:v' + $.values.common.versions.blackboxExporter,
        grafana: 'harbor.alnk.com/public/grafana:' + $.values.common.versions.grafana,
        kubeStateMetrics: 'harbor.alnk.com/public/kube-state-metrics:v' + $.values.common.versions.kubeStateMetrics,
        nodeExporter: 'harbor.alnk.com/public/node-exporter:v' + $.values.common.versions.nodeExporter,
        prometheus: 'harbor.alnk.com/public/prometheus:v' + $.values.common.versions.prometheus,
        prometheusAdapter: 'harbor.alnk.com/public/prometheus-adapter:v' + $.values.common.versions.prometheusAdapter,
        prometheusOperator: 'harbor.alnk.com/public/prometheus-operator:v' + $.values.common.versions.prometheusOperator,
        prometheusOperatorReloader: 'harbor.alnk.com/public/prometheus-config-reloader:v' + $.values.common.versions.prometheusOperator,
        kubeRbacProxy: 'harbor.alnk.com/public/kube-rbac-proxy:v' + $.values.common.versions.kubeRbacProxy,
        configmapReload: 'harbor.alnk.com/public/configmap-reload:v' + $.values.common.versions.configmapReload,
      },
    },
    alertmanager: {
      name: 'main',
