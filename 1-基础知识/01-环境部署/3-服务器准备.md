...
```
直接克隆模板机的ubuntu系统，修改主机名称和IP地址即可
root@ubuntu2204-base:~# hostnamectl set-hostname ops
root@ubuntu2204-base:~# vi /etc/netplan/00-installer-config.yaml
root@ubuntu2204-base:~# netplan apply
```
